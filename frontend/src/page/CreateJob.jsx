    ...
    useEffect(() => {
        ...
        if (savedData) {
            try {
                ...
                console.log('已載入儲存的資料:', parsedData);
            } catch (error) {
        ...
        <div className="create-job-page">
            ...
            <form onSubmit={handleSubmit}>
                <div className="create-job-input-box first-child">
                    <label htmlFor="job-name" className="create-job-label">Job name:</label>
                    <input 
                        type="text" 
                        id="job-name"
                        name="job_name"
                ...
                <div className="create-job-input-box">
                    <label htmlFor="job-type" className="create-job-label">Job type:</label>
                    <input 
                        type="text" 
                        id="job-type"
                        name="job_type"
                ...
                <div className="create-job-input-box">
                    <label htmlFor="payment" className="create-job-label">Payment:</label>
