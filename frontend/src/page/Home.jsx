...
function HomePage() {
  ...
  const videos = [ // TODO: 模擬影片用的靜態array，這邊要改成從資料庫抓影片
    { id: 1, name: "Video 1", data: "Bnana is very yummy", videoUrl: "/video/test.mp4" },
    { id: 2, name: "Video 2", data: "cat looks sad", videoUrl: "/video/test2.mp4" },
    { id: 3, name: "Video 3", data: "crying cat looks yummy", videoUrl: "/video/test.mp4" }
  ];
      ...
      <div className="video-screen">
        {mode === 'short' ? (
          <div className="video-item">
            ...
            <video className="video" key={videos[currentIndex].videoUrl} autoPlay loop playsInline>
